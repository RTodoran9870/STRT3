...
import com.example.rtodo.strt3.Config.Config;
...
public class Ring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        snooze = findViewById(R.id.snoozebuttonID);
    ...
    private void processPayment() {
        PayPalPayment PayPalpayment = new PayPalPayment(new BigDecimal(String.valueOf(amount)), "GBP", "pay for snoozing", PayPalPayment.PAYMENT_INTENT_SALE);
